...
export const CAT_ALIASES_NODE_API_PATH = `${BASE_OPENSEARCH_NODE_API_PATH}/catAliases`;
...
export const ML_INTERFACE_LINK =
  'https://docs.opensearch.org/latest/ml-commons-plugin/api/model-apis/register-model/#the-interface-parameter';
...
export const AGENTIC_QUERY_DSL_DOCS_LINK =
  'https://docs.opensearch.org/latest/query-dsl/specialized/agentic/';
